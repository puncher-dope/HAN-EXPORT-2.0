...
const services = [
  {
    ...
    description:
      "Находим лучшие предложения на корейских аукционах и у дилеров с учетом ваших требований и бюджета.",
  },
  {
    icon: Shield,
    title: "Проверка и диагностика",
    description:
      "Полная проверка истории автомобиля, техническая диагностика и фотоотчет перед покупкой.",
  },
  {
    icon: FileText,
    title: "Оформление документов",
    description:
      "Берем на себя весь документооборот: контракт, таможенная декларация, сертификат соответствия.",
  },
  {
    icon: Truck,
    title: "Логистика и доставка",
    description:
      "Оптимизируем маршрут доставки: морем через Владивосток или автотранспортом напрямую.",
  },
  {
    icon: Wrench,
    title: "Предпродажная подготовка",
    description:
      "Комплексное ТО, замена расходников, косметический ремонт перед передачей клиенту.",
  },
  {
    icon: BadgeCheck,
    title: "Гарантия и поддержка",
    description:
      "Гарантия на каждый автомобиль и послепродажное обслуживание на всем пути владения.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mt-3">
            Полный цикл <span className="text-gradient">экспорта</span>
          </h2>
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto text-lg">
            От подбора до ключей в руке — мы берем на себя каждый этап
          </p>
        </motion.div>
