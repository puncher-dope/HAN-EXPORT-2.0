...
const steps = [
  {
    step: "01",
    title: "Заявка",
    description: "Вы оставляете заявку с пожеланиями по марке, модели и бюджету.",
  },
  {
    step: "02",
    title: "Подбор",
    description: "Наши эксперты в Корее находят варианты на аукционах и у дилеров.",
  },
  {
    step: "03",
    title: "Проверка",
    description: "Проводим диагностику, проверяем историю и отправляем вам отчет.",
  },
  {
    step: "04",
    title: "Оплата и контракт",
    description: "Заключаем договор, вы вносите оплату на счет компании.",
  },
  {
    step: "05",
    title: "Доставка",
    description: "Организуем логистику, оформляем таможню и доставляем в ваш город.",
  },
  {
    step: "06",
    title: "Передача",
    description: "Вы получаете автомобиль с полным пакетом документов и гарантией.",
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mt-3">
            6 шагов к <span className="text-gradient">вашему авто</span>
          </h2>
        </motion.div>
